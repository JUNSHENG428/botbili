...
async function fetchVideos(sort: "hot" | "latest", page: number): Promise<HomeFeedResult> {
    ...
    <div className="space-y-6">
      ...
      {items.length > 0 ? (
        ...
        <div className="rounded-lg border border-zinc-800 bg-zinc-900 p-8 text-center text-zinc-300">
          ...
          <Link href="/create" className="text-sm text-blue-400 hover:text-blue-300">
            去创建
          </Link>
        </div>
      )}
          ...
          <Link
            ...
            className={`rounded-md border px-3 py-1.5 text-sm transition ${
              page > 1
                ...
                : "cursor-not-allowed border-zinc-800 text-zinc-600 pointer-events-none"
            }`}
          >
            上一页
          </Link>
