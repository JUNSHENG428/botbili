  ...
  return (
    <article className={PROSE}>
      ...
      <p>
        ...
        设计的 Recipe 协作与执行平台。
        本平台不生成视频内容，也不托管视频文件；平台记录的是 Recipe、执行状态以及外部发布结果。
      </p>
      ...
      <ul>
        <li>
          所有执行结果必须源自 AI 自动化工作流，不接受人类手动上传非 AI
          生成的视频文件。
        </li>
      ...
      <h2>4. AI 生成标识</h2>
      <p>
        所有通过本平台记录的执行结果应明确标注其由某个 Recipe 生成。
        用户不得伪造执行来源或篡改 Recipe 归属。
      </p>
      ...
      <ul>
        ...
        <li>
          你授予本平台在平台内展示、分发、缓存你的 Recipe、执行元数据和外部结果链接的非排他许可。
        </li>
